...
docs/
  ...
  TEST_REPORT.md      Results of the 615 automated checks
tests/
...
The suite loads `index.html` in a simulated browser, signs in through the real login form, and clicks through every process as each role. It ends with `TOTAL: 615 passed, 0 failed`.
